...
$(function() {
    ...
    bd_Info_Array.push({Date: '2020-03-25', T_Tests: 82,T_Positive_Cases: 0, T_Deaths: 0, T_Recovary: 7, Total: 39});
    bd_Info_Array.push({Date: '2020-03-26', T_Tests: 126,T_Positive_Cases: 5, T_Deaths: 0, T_Recovary: 4, Total: 44});
    bd_Info_Array.push({Date: '2020-03-27', T_Tests: 106,T_Positive_Cases: 4, T_Deaths: 0, T_Recovary: 0, Total: 48});
    bd_Info_Array.push({Date: '2020-03-28', T_Tests: 50,T_Positive_Cases: 0, T_Deaths: 0, T_Recovary: 4, Total: 48});
    bd_Info_Array.push({Date: '2020-03-29', T_Tests: 109,T_Positive_Cases: 0, T_Deaths: 0, T_Recovary: 0, Total: 48});
    bd_Info_Array.push({Date: '2020-03-30', T_Tests: 153,T_Positive_Cases: 1, T_Deaths: 0, T_Recovary: 4, Total: 49});
    bd_Info_Array.push({Date: '2020-03-31', T_Tests: 140,T_Positive_Cases: 2, T_Deaths: 0, T_Recovary: 6, Total: 51});
    bd_Info_Array.push({Date: '2020-04-01', T_Tests: 157,T_Positive_Cases: 3, T_Deaths: 1, T_Recovary: 0, Total: 54});
    bd_Info_Array.push({Date: '2020-04-02', T_Tests: 141,T_Positive_Cases: 2, T_Deaths: 0, T_Recovary: 0, Total: 56});
    bd_Info_Array.push({Date: '2020-04-03', T_Tests: 203,T_Positive_Cases: 5, T_Deaths: 0, T_Recovary: 1, Total: 61});
    bd_Info_Array.push({Date: '2020-04-04', T_Tests: 434,T_Positive_Cases: 9, T_Deaths: 1, T_Recovary: 4, Total: 70});
    bd_Info_Array.push({Date: '2020-04-05', T_Tests: 367,T_Positive_Cases: 18, T_Deaths: 1, T_Recovary: 3, Total: 88});
    bd_Info_Array.push({Date: '2020-04-06', T_Tests: 468,T_Positive_Cases: 35, T_Deaths: 3, T_Recovary: 0, Total: 123});
    bd_Info_Array.push({Date: '2020-04-07', T_Tests: 792,T_Positive_Cases: 41, T_Deaths: 5, T_Recovary: 0, Total: 164});
    bd_Info_Array.push({Date: '2020-04-08', T_Tests: 981,T_Positive_Cases: 54, T_Deaths: 3, T_Recovary: 0, Total: 218});
    bd_Info_Array.push({Date: '2020-04-09', T_Tests: 1097,T_Positive_Cases: 112, T_Deaths: 1, T_Recovary: 0, Total: 330});
    bd_Info_Array.push({Date: '2020-04-10', T_Tests: 1184,T_Positive_Cases: 94, T_Deaths: 6, T_Recovary: 0, Total: 424});
    ...
    bd_Info_Array.push({Date: '2020-04-22', T_Tests: 3052,T_Positive_Cases: 390, T_Deaths: 10, T_Recovary: 5, Total: 3772});
    bd_Info_Array.push({Date: '2020-04-23', T_Tests: 3416,T_Positive_Cases: 414, T_Deaths: 7, T_Recovary: 16, Total: 4186});
    bd_Info_Array.push({Date: '2020-04-24', T_Tests: 3430,T_Positive_Cases: 503, T_Deaths: 4, T_Recovary: 4, Total: 4689});
