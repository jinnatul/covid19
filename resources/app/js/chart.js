    ...
    var Chart_DhakaInfo = new CanvasJS.Chart("chart_column", {
        ...
        data: [{
            ...
            dataPoints: [
                ...
                { y: 1, label: "Ashkona" },
                { y: 11, label: "Azimpur" },
                { y: 11, label: "Babu Bazar" },
                { y: 8, label: "Badda" },
                { y: 3, label: "Baily Road" },
                { y: 8, label: "Banani" },
                { y: 15, label: "Bangshal" },
                { y: 17, label: "Basabo" },
                { y: 5, label: "Bashundhara" },
                { y: 1, label: "Begunbari" },
                { y: 1, label: "Beribadh" },
                { y: 1, label: "Bosila" },
                { y: 1, label: "BUET Area" },
                { y: 6, label: "Chankharpool" },
                { y: 1, label: "Central Road" },
                { y: 10, label: "Chawk Bazar" },
                { y: 1, label: "Dhakeshwari" },
                { y: 18, label: "Dhanmondi" },
                { y: 2, label: "Demra" },
                ...
                { y: 1, label: "Farmgate" },
                { y: 14, label: "Gendaria" },
                { y: 10, label: "Green Road" },
                { y: 3, label: "Gulistan" },
                { y: 13, label: "Gulshan" },
                { y: 1, label: "Hatirjheel" },
                { y: 3, label: "Hatirpool" },
                { y: 15, label: "Hazaribagh" },
                { y: 2, label: "Islampur" },
                { y: 2, label: "Jailgate" },
                { y: 23, label: "Jatrabari" },
                { y: 5, label: "Jigatola" },
                { y: 3, label: "Jurain" },
                { y: 4, label: "Kamrangir char" },
                { y: 3, label: "Kazipara" },
                { y: 2, label: "Kodomtoli" },
                { y: 4, label: "Kotowali" },
                { y: 21, label: "Lalbagh" },
                { y: 4, label: "Laxmibazar" },
                { y: 2, label: "Malibagh" },
                { y: 1, label: "Manikdi" },
                ...
                { y: 3, label: "Mirpur-6" },
                { y: 7, label: "Mirpur-10" },
                { y: 13, label: "Mirpur-11" },
                { y: 11, label: "Mirpur-12" },
                { y: 2, label: "Mirpur-13" },
                { y: 6, label: "Mirpur-14" },
                { y: 17, label: "Mitford" },
                { y: 11, label: "MogBazar" },
                { y: 12, label: "Mohakhali" },
                { y: 22, label: "Mohammadpur" },
                { y: 3, label: "Mugda" },
                { y: 1, label: "Nawabpur" },
                { y: 2, label: "Nawabganj" },
                { y: 3, label: "Narinda" },
                ...
                { y: 6, label: "Shahbagh" },
                { y: 7, label: "Shakharibazar" },
                { y: 7, label: "Shantinagar" },
                { y: 4, label: "Shaymoli" },
                { y: 3, label: "Showari Ghat" },
                { y: 3, label: "Siddheshwari" },
